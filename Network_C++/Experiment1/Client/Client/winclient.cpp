...
int main(int argc, char* argv[])
{
	...
	sprintf(sendData, "[From TCP Client] Hello, This is TCP Client!");
	...
	// 该处增加代码，实现实验要求以下功能：
	// （4）客户端端循环从键盘接收报文信息，并发送该报文到服务器端；
	//客户端在命令行输入个人的姓名学号信息“Hello I’m Lan HaiTao(190310426).”发送给服务器
	// （5）如果键盘输入报文信息为"EXIT" ，发送该报文后服务端不再继续接收用户输入。
	while (1) {
	printf("请输入报文信息：");
