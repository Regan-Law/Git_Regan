...
LunarCalendarWidget::LunarCalendarWidget(QWidget *parent) : QWidget(parent)
{
    ...
    if (!fontDb.families().contains("FontAwesome")) {
        int fontId = fontDb.addApplicationFont(":/font/resource/fontawesome-webfont.ttf");
    ...
    selectBgColor = QColor(64,224,208);
...
void LunarCalendarWidget::initStyle()
{
    ...
    //转到今天
    qss.append(QString("QPushButton{background:#00a4ff;color:#FFFFFF;border-radius:5px;}"));
